...
char ssid[] = "A51";           // nome do seu roteador WIFI (SSID)
char password[] = "imortaltricolor";

// Inicializa o BOT Telegram - copie aqui a chave Token quando configurou o seu BOT - entre aspas
#define BOTtoken "6147023314:AAGQbJ6LAYLJCPIL8aZH2A8G7VB-0_55eck"  // sua chave Token Bot
...
const int ledPin = 13;    // GPIO_16 do LED azul
int ledStatus = 0;
