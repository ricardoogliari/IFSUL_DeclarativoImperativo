...
#define WIFI_SSID "A51"
#define WIFI_PASSWORD "imortaltricolor"
...
#define API_KEY "AIzaSyCpF-Ii-5d2X3z0NtDwrvjPPhZl3dEi-2E"

/* 3. Define the RTDB URL */
#define DATABASE_URL "fcmflutter-10c50.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "rogliariping@gmail.com"
...
void loop()
{
  ...
  {
//    Serial.print("Room... ");
//    Serial.print(Firebase.getInt(fbdo, F("/test/room")) ? fbdo.to<int>() : 10);
    
    if (Firebase.getInt(fbdo, F("/test/room")) ? fbdo.to<int>() : 1){
